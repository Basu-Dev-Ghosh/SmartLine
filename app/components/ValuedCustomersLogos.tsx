      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Our Valued Customers</h2>
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Trusted by leading organizations across various sectors throughout Eastern India
          </p>
        </motion.div>
        ...
        <div className="mt-12 grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4">
          {[
            ...
            >
              <div className="text-lg md:text-xl font-bold text-red-600">{sector.count}+</div>
